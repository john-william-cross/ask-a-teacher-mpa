   ...
   },
   {
      ...
      answers: [
         ...
         },
         {
            ...
            text: "If it is multiplication, please google `area model multiplication common core` and you should find some good examples",
