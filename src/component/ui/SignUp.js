...
export default class SignUp extends React.Component {
   ...
   constructor(props) {
      super(props);
      console.log("In a new class ssscomponent!");
      this.state = {
         isDisplayingSignUpInputs: false,
      };
      //   this.state = {
      //      isDisplayingLogInInputs: true,
      //   };
   }
   ...
   //    toggleLogInInputs() {
   //       this.setState({
   //          isDisplayingLogInInputs: !this.state.isDisplayingLogInInputs,
   //       });
   //    }
      ...
      return (
         <>
            <div className="container">
               <div className="row">
                  <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2 mt-5">
                     <div className="text-center show-sign-up-info">
                        <p>First time here?</p>
                        <Link
                           className="sign-in sign-up-prompt"
                           onClick={() => {
                              this.toggleSignUpInputs();
                              //   this.toggleLogInInputs();
                           }}
                        >
                           Sign up{" "}
                        </Link>
                     ...
                     <div className="email-and-create-password ">
                        {this.state.isDisplayingSignUpInputs && (
                           //    this.state.isDisplayingLogInInputs &&
                           <>
